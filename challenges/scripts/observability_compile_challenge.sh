#!/usr/bin/env bash
# observability_compile_challenge.sh - Validates Observability module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.observability"
if grep -q "^module digital.vasic.observability$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.observability"
else
